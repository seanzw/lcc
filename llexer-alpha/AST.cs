...
namespace llexer {
    ...
    ***************************************************/
    ...
    public class ASTLex : ASTNode {
        public ASTLex(List<ASTRule> rules, ASTCode code) {
            this.rules = rules;
            this.code = code;
        }
    ...
    public class ASTRule : ASTNode {
        public ASTRule(ASTReg reg, ASTCode code) {
            this.reg = reg;
            this.code = code;
        }
        ...
        public readonly ASTReg reg;
        public readonly ASTCode code;
    }

    public abstract class ASTReg : ASTNode {
        public ASTReg() { }

        /* Convert the reg to a NFA transition table. */
        abstract public NFATable toNFA();
    }

    public class ASTRegStar : ASTReg {
        public ASTRegStar(ASTReg reg) {
            this.reg = reg;
        }
    ...
    public class ASTRegAnd : ASTReg {
        public ASTRegAnd(ASTReg lhs, ASTReg rhs) {
            this.lhs = lhs;
            this.rhs = rhs;
        }
        ...
        private ASTReg lhs, rhs;
    }

    public class ASTRegOr : ASTReg {

        public ASTRegOr(ASTReg lhs, ASTReg rhs) {
            this.lhs = lhs;
            this.rhs = rhs;
        }
