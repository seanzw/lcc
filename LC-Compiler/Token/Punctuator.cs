namespace lcc.Token {
    ...
    /// [
    /// </summary>
    public sealed class T_PUNC_SUBSCRIPTL : Token {
    ...
    /// ]
    /// </summary>
    public sealed class T_PUNC_SUBSCRIPTR : Token { // "]"
    ...
    /// (
    /// </summary>
    public sealed class T_PUNC_PARENTL : Token { // "("
    ...
    /// )
    /// </summary>
    public sealed class T_PUNC_PARENTR : Token { // ")"
    ...
    /// {
    /// </summary>
    public sealed class T_PUNC_BRACEL : Token { // "{"
    ...
    /// }
    /// </summary>
    public sealed class T_PUNC_BRACER : Token { // "}"
    ...
    /// .
    /// </summary>
    public sealed class T_PUNC_DOT : Token { // "."
    ...
    /// ->
    /// </summary>
    public sealed class T_PUNC_PTRSEL : Token { // "->"
    ...
    /// ++
    /// </summary>
    public sealed class T_PUNC_INCRE : Token { // "++"
    ...
    /// --
    /// </summary>
    public sealed class T_PUNC_DECRE : Token { // "--"
    ...
    /// &
    /// </summary>
    public sealed class T_PUNC_REF : Token { // "&"
    ...
    /// *
    /// </summary>
    public sealed class T_PUNC_STAR : Token { // "*"
    ...
    /// +
    /// </summary>
    public sealed class T_PUNC_PLUS : Token { // "+"
    ...
    /// -
    /// </summary>
    public sealed class T_PUNC_MINUS : Token { // "-"
    ...
    /// ~
    /// </summary>
    public sealed class T_PUNC_BITNOT : Token { // "~"
    ...
    /// !
    /// </summary>
    public sealed class T_PUNC_LOGNOT : Token { // "!"
    ...
    /// /
    /// </summary>
    public sealed class T_PUNC_SLASH : Token { // "/"
    ...
    /// %
    /// </summary>
    public sealed class T_PUNC_MOD : Token { // "%"
    ...
    /// &lt&lt
    /// </summary>
    public sealed class T_PUNC_SHIFTL : Token { // "<<"
    ...
    /// &gt&gt
    /// </summary>
    public sealed class T_PUNC_SHIFTR : Token { // ">>"
    ...
    /// &lt
    /// </summary>
    public sealed class T_PUNC_LT : Token { // "<"
    ...
    /// &gt
    /// </summary>
    public sealed class T_PUNC_GT : Token { // ">"
    ...
    /// &lt=
    /// </summary>
    public sealed class T_PUNC_LE : Token { // "<="
    ...
    /// &gt=
    /// </summary>
    public sealed class T_PUNC_GE : Token { // ">="
    ...
    /// ==
    /// </summary>
    public sealed class T_PUNC_EQ : Token { // "=="
    ...
    /// !=
    /// </summary>
    public sealed class T_PUNC_NEQ : Token { // "!="
    ...
    /// ^
    /// </summary>
    public sealed class T_PUNC_BITXOR : Token { // "^"
    ...
    /// |
    /// </summary>
    public sealed class T_PUNC_BITOR : Token { // "|"
    ...
    /// &&
    /// </summary>
    public sealed class T_PUNC_LOGAND : Token { // "&&"
    ...
    /// ||
    /// </summary>
    public sealed class T_PUNC_LOGOR : Token { // "||"
    ...
    /// ?
    /// </summary>
    public sealed class T_PUNC_QUESTION : Token { // "?"
    ...
    /// :
    /// </summary>
    public sealed class T_PUNC_COLON : Token { // ":"
    ...
    /// ;
    /// </summary>
    public sealed class T_PUNC_SEMICOLON : Token { // ";"
    ...
    /// ...
    /// </summary>
    public sealed class T_PUNC_ELLIPSIS : Token { // "..."
    ...
    /// =
    /// </summary>
    public sealed class T_PUNC_ASSIGN : Token { // "="
    ...
    /// *=
    /// </summary>
    public sealed class T_PUNC_MULEQ : Token { // "*="
    ...
    /// /=
    /// </summary>
    public sealed class T_PUNC_DIVEQ : Token { // "/="
    ...
    /// %=
    /// </summary>
    public sealed class T_PUNC_MODEQ : Token { // "%="
    ...
    /// +=
    /// </summary>
    public sealed class T_PUNC_PLUSEQ : Token { // "+="
    ...
    /// -=
    /// </summary>
    public sealed class T_PUNC_MINUSEQ : Token { // "-="
    ...
    /// &lt&lt=
    /// </summary>
    public sealed class T_PUNC_SHIFTLEQ : Token { // "<<="
    ...
    /// &gt&gt=
    /// </summary>
    public sealed class T_PUNC_SHIFTREQ : Token { // ">>="
    ...
    /// &=
    /// </summary>
    public sealed class T_PUNC_BITANDEQ : Token { // "&="
    ...
    /// ^=
    /// </summary>
    public sealed class T_PUNC_BITXOREQ : Token { // "^="
    ...
    /// |=
    /// </summary>
    public sealed class T_PUNC_BITOREQ : Token { // "|="
    ...
    /// ,
    /// </summary>
    public sealed class T_PUNC_COMMA : Token { // ","
